...
class MainRepositoryImpl @Inject constructor(db: SongDatabase,val prefs:MyPreferences):MainRepository {
    ...
    override suspend fun deleteSongByPath(songPath: Long): Int=withContext(Dispatchers.IO) {
    ...
    override suspend fun deleteAllSongsState(): Int = withContext(Dispatchers.IO) {
        songDao.deleteAllSongsState()
    }
    // Playlist
